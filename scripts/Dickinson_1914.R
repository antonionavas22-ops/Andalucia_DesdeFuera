...
#localidades
write_csv(resultado, "resultado_localidades_Dickinson.csv") 
#patrimonio material
write_csv(resultado_material, "resultado_material_Dickinson.csv")
#patrimonio inmaterial
write_csv(resultado_inmaterial, "resultado_inmaterial_Dickinson.csv") 
...
ggplot(top25, aes(x = reorder(principal, menciones), y = menciones, fill = tipo)) +
  ...
  labs(title = "Menciones en Dickinson (1914)",
       x = NULL, y = "Menciones") +
  theme_minimal() +
  theme(legend.position = "none")
#dédimotercer paso o epílogo: exportación a imagen
ggsave("grafica_Dickinson.png", width = 12, height = 8) 
