...
#localidades
write_csv(resultado, "resultado_localidades_Franck.csv") 
#patrimonio material
write_csv(resultado_material, "resultado_material_Franck.csv")
#patrimonio inmaterial
write_csv(resultado_inmaterial, "resultado_inmaterial_Franck.csv") 
...
ggplot(top25, aes(x = reorder(principal, menciones), y = menciones, fill = tipo)) +
  ...
  labs(title = "Menciones en Franck (1911)",
       x = NULL, y = "Menciones") +
  theme_minimal() +
  theme(legend.position = "none")
#dédimotercer paso o epílogo: exportación a imagen
ggsave("grafica_Franck.png", width = 12, height = 8) 