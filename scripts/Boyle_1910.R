...
relato <- readLines("1910_Boyle_heroic_spain.txt" , encoding = "UTF-8")
...
#localidades
write_csv(resultado, "resultado_localidades_Boyle_heroic_spain.csv") 
#patrimonio material
write_csv(resultado_material, "resultado_material_Boyle_heroic_spain.csv")
#patrimonio inmaterial
write_csv(resultado_inmaterial, "resultado_inmaterial_Boyle_heroic_spain.csv") 
...
ggplot(top20, aes(x = reorder(principal, menciones), y = menciones, fill = tipo)) +
  ...
  labs(title = "Frecuencia en heroic Spain de Boyle (1910)",
       x = NULL, y = "Menciones") +
  theme_minimal() +
  theme(legend.position = "none")

#por último se exporta la imagen ajustada
ggsave("1910_patrimonio__Boyle_heroic_spain.png", width = 12, height = 8) 
...
barplot(totales,
        las = 2,
        col = colores,
        main = "Análisis de sentimientos - Boyle 1910 Heroic spain  ",
...
write.csv(totales, "1910_sentimientos_Boyle_heroic_spain.csv")
