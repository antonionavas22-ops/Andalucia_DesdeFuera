...
relato <- readLines("1908_Elliott_sun_shadow.txt" , encoding = "UTF-8")
...
#localidades
write_csv(resultado, "resultado_localidades_Elliott_sun_shadow.csv") 
#patrimonio material
write_csv(resultado_material, "resultado_material_Elliott_sun_shadow.csv")
#patrimonio inmaterial
write_csv(resultado_inmaterial, "resultado_inmaterial_Elliott_sun_shadow.csv") 
...
ggplot(top20, aes(x = reorder(principal, menciones), y = menciones, fill = tipo)) +
  ...
  labs(title = "Frecuencia en sun and shadow de Elliott (1908)",
       x = NULL, y = "Menciones") +
  theme_minimal() +
  theme(legend.position = "none")

#por último se exporta la imagen ajustada
ggsave("1908_patrimonio__Elliott_sun_shadow.png", width = 12, height = 8) 
...
barplot(totales,
        las = 2,
        col = colores,
        main = "Análisis de sentimientos - Elliot 1908  Sun shadow",
...
write.csv(totales, "1908_sentimientos_Elliott_Sun_shadow.csv")
