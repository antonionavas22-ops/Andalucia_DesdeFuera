...
relato <- readLines("1902_Williams_land_dons.txt", encoding = "UTF-8")
...
#localidades
write_csv(resultado, "resultado_localidades_Williams.csv") 
#patrimonio material
write_csv(resultado_material, "resultado_material_Williams.csv")
#patrimonio inmaterial
write_csv(resultado_inmaterial, "resultado_inmaterial_WIlliams.csv") 
...
ggplot(top20, aes(x = reorder(principal, menciones), y = menciones, fill = tipo)) +
  ...
  labs(title = "Frecuencia en The land of the londs de Williams (1902)",
       x = NULL, y = "Menciones") +
  theme_minimal() +
  theme(legend.position = "none")

#por último se exporta la imagen ajustada
ggsave("1902_grafica_Williams_land_of_the_londs.png", width = 12, height = 8) 
...
barplot(totales,
        las = 2,
        col = colores,
        main = "Análisis de sentimientos - WIlliams 1902 Land of the dons",
...
write.csv(totales, "sentimientos_Williams.csv")
