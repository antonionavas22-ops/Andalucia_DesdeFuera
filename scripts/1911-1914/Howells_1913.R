...
#localidades
write_csv(resultado, "resultado_localidades_Howells_family_spanish.csv") 
#patrimonio material
write_csv(resultado_material, "resultado_material_Howells_family_spanish.csv")
#patrimonio inmaterial
write_csv(resultado_inmaterial, "resultado_inmaterial_Howells_family_spanish.csv")
...
ggplot(top20, aes(x = reorder(principal, menciones), y = menciones, fill = tipo)) +
  ...
  labs(title = "Frecuencia en family spanish de Howells (1913)",
       x = NULL, y = "Menciones") +
  theme_minimal() +
  theme(legend.position = "none")

#por último se exporta la imagen ajustada
ggsave("1913_patrimonio__howells_family_spanish.png", width = 12, height = 8) 
...
barplot(totales,
        las = 2,
        col = colores,
        main = "Análisis sentimientos -Howells 1913 family spanish",
...
write.csv(totales, "1913_sentimientos_howells_spanish_travel.csv")
