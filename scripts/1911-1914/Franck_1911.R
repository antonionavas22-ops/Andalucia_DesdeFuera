...
relato <- readLines("1911_Franck_four_months.txt" , encoding = "UTF-8")
...
#localidades
write_csv(resultado, "resultado_localidades_franck_four_months.csv") 
#patrimonio material
write_csv(resultado_material, "resultado_material_franck_four_months.csv")
#patrimonio inmaterial
write_csv(resultado_inmaterial, "resultado_inmaterial_franck_four_months.csv") 
...
ggplot(top20, aes(x = reorder(principal, menciones), y = menciones, fill = tipo)) +
  ...
  labs(title = "Frecuencia en Four months de Franck (1911)",
       x = NULL, y = "Menciones") +
  theme_minimal() +
  theme(legend.position = "none")

#por último se exporta la imagen ajustada
ggsave("1911_patrimonio__franck_four_months.png", width = 12, height = 8) 
...
barplot(totales,
        las = 2,
        col = colores,
        main = "Análisis de sentimientos - franck 1911 four months  ",
...
write.csv(totales, "1911_sentimientos_Franck_four_months.csv")
