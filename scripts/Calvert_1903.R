...
relato <- readLines("1903_Calvert_impressions_spain.txt" , encoding = "UTF-8")
...
#localidades
write_csv(resultado, "resultado_localidades_Calvert_Impression_spain.csv") 
#patrimonio material
write_csv(resultado_material, "resultado_material_Calvert_Impression_spain.csv")
#patrimonio inmaterial
write_csv(resultado_inmaterial, "resultado_inmaterial_Calvert_Impression_spain.csv") 
...
ggplot(top20, aes(x = reorder(principal, menciones), y = menciones, fill = tipo)) +
  ...
  labs(title = "Frecuencia en Impressions of Spain de Calvert (1903)",
       x = NULL, y = "Menciones") +
  theme_minimal() +
  theme(legend.position = "none")

#por último se exporta la imagen ajustada
ggsave("1903_patrimonio_Calvert_Impressions_Spain.png", width = 12, height = 8) 
...
barplot(totales,
        las = 2,
        col = colores,
        main = "Análisis de sentimientos - Calvert 1903 Impressions of Spain",
...
write.csv(totales, "1903_sentimientos_Calvert_Impressions_Spain.csv")
