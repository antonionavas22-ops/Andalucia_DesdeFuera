...
relato <- readLines("1905_Somerset_blessed_virgin.txt" , encoding = "UTF-8")
...
#localidades
write_csv(resultado, "resultado_localidades_Maugham_blessed_virgin.csv") 
#patrimonio material
write_csv(resultado_material, "resultado_material_Maugham_blessed_virgin.csv")
#patrimonio inmaterial
write_csv(resultado_inmaterial, "resultado_inmaterial_Maugham_blessed_virgin.csv") 
...
ggplot(top20, aes(x = reorder(principal, menciones), y = menciones, fill = tipo)) +
  ...
  labs(title = "Frecuencia en Blessed Virgin de Maugham (1905)",
       x = NULL, y = "Menciones") +
  theme_minimal() +
  theme(legend.position = "none")

#por último se exporta la imagen ajustada
ggsave("1905_patrimonio_Maugham_blessed_virgin.png", width = 12, height = 8) 
...
barplot(totales,
        las = 2,
        col = colores,
        main = "Análisis de sentimientos - Maugham 1905 Blessed virgin",
...
write.csv(totales, "1905_sentimientos_Maugham_blessed_virgin.csv")
