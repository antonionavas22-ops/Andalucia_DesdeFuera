...
relato <- readLines("1909_Collins_cathedral.txt" , encoding = "UTF-8")
...
#localidades
write_csv(resultado, "resultado_localidades_Collins_cathedrals.csv") 
#patrimonio material
write_csv(resultado_material, "resultado_material_Collins_cathedrals.csv")
#patrimonio inmaterial
write_csv(resultado_inmaterial, "resultado_inmaterial_Collins_cathedrals.csv") 
...
ggplot(top20, aes(x = reorder(principal, menciones), y = menciones, fill = tipo)) +
  ...
  labs(title = "Frecuencia en cathedrals de Collins (1909)",
       x = NULL, y = "Menciones") +
  theme_minimal() +
  theme(legend.position = "none")

#por último se exporta la imagen ajustada
ggsave("1909_patrimonio__Collins_cathedrals.png", width = 12, height = 8) 
...
barplot(totales,
        las = 2,
        col = colores,
        main = "Análisis de sentimientos - Collins 1909 Cathedrals  ",
...
write.csv(totales, "1909_sentimientos_Collins_cathedrals.csv")
