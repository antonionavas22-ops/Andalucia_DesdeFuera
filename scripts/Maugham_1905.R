...
#localidades
write_csv(resultado, "resultado_localidades_Maugham.csv") 
#patrimonio material
write_csv(resultado_material, "resultado_material_Maugham.csv")
#patrimonio inmaterial
write_csv(resultado_inmaterial, "resultado_inmaterial_Maugham.csv") 
...
ggplot(top25, aes(x = reorder(principal, menciones), y = menciones, fill = tipo)) +
  ...
  labs(title = "Menciones en Maugham (1905)",
       x = NULL, y = "Menciones") +
  theme_minimal() +
  theme(legend.position = "none")
#dédimotercer paso o epílogo: exportación a imagen
ggsave("grafica_Maugham.png", width = 12, height = 8) 